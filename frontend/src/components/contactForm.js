        ...
        <Form noValidate onSubmit={handleSubmit} >
          <Row className="mb-3">
            <Form.Group as={Col} md="2" controlId="validationFormik01">
              <Form.Label style={{ color: 'white', fontSize: '30px' }}>Name</Form.Label>
              <Form.Control
                type="text"
                name="name"
            ...
            <Form.Group as={Col} md="3" controlId="validationFormik02">
              <Form.Label style={{ color: 'white', fontSize: '30px' }}>Email</Form.Label>
              <Form.Control
                type="email"
                name="email"
                value={values.email}
          ...
          <Row className="mb-3">
            <Form.Group as={Col} md="2" controlId="validationFormik03">
              <Form.Label style={{ color: 'white', fontSize: '30px' }}>Mobile Number</Form.Label>
              <Form.Control
                type="text"
                name="phoneNumber"
            ...
            <Form.Group as={Col} md="4" controlId="validationFormik04">
              <Form.Label style={{ color: 'white', fontSize: '30px' }}>Subject</Form.Label>
              <Form.Control
                type="text"
                name="subject"
        ...
        <br /><br />
          <Row className="mb-3">
            <Form.Group as={Col} controlId="validationFormik05">
              <Form.Label style={{ color: 'white', fontSize: '30px' }}>Message</Form.Label>
              <Form.Control
                as="textarea"
                rows={2}
                name="message"
